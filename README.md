...
Developed the **largest**, and **first real-field image (India)** plant disease dataset comprising **4,200** images of **Citrus**.
...
4. The dataset contains a total of **4,200** images encompassing both citrus fruits and leaves, representing healthy and diseased conditions. Each image has a spatial resolution of $2400 \times 2400$ pixels with a resolution of $1200$ dpi.
